...
class InfiniteGridMenu {
  ...
  private render(): void {
    ...
    gl.clearColor(46 / 255, 42 / 255, 66 / 255, 1); // #1F1C2C
...
const InfiniteMenu: FC<InfiniteMenuProps> = ({ items = [] }) => {
  ...
  return (
    <div className="relative w-full h-full bg-custom-lightGray" style={{ backgroundColor: '#1F1C2C' }}>
      <canvas
        id="infinite-grid-menu-canvas"
        ref={canvasRef}
        className="cursor-grab bg-custom-lightGray w-full h-full overflow-hidden relative outline-none active:cursor-grabbing"
  ...
  `}
>
  {activeItem.title.split(" ").map((word, index) => (
